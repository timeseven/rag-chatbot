...
function P({ className, asChild = false, ...props }: TypographyProps) {
	const Component = asChild ? Slot.Text : RNText;
	return <Component className={cn('text-base text-foreground web:select-text', className)} {...props} />;
}
...
function Lead({ className, asChild = false, ...props }: TypographyProps) {
	const Component = asChild ? Slot.Text : RNText;
	return <Component className={cn('text-xl text-muted-foreground web:select-text', className)} {...props} />;
}

function Large({ className, asChild = false, ...props }: TypographyProps) {
	const Component = asChild ? Slot.Text : RNText;
	return <Component className={cn('text-xl font-semibold text-foreground web:select-text', className)} {...props} />;
}
...
function Muted({ className, asChild = false, ...props }: TypographyProps) {
	const Component = asChild ? Slot.Text : RNText;
	return <Component className={cn('text-sm text-muted-foreground web:select-text', className)} {...props} />;
}
